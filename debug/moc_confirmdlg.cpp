/****************************************************************************
** Meta object code from reading C++ file 'confirmdlg.h'
**
...
#error "The header file 'confirmdlg.h' doesn't include <QObject>."
...
const QMetaObject ConfirmDlg::staticMetaObject = {
    { &FramelessWin2::staticMetaObject, qt_meta_stringdata_ConfirmDlg,
...
void *ConfirmDlg::qt_metacast(const char *_clname)
{
    ...
    return FramelessWin2::qt_metacast(_clname);
}

int ConfirmDlg::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = FramelessWin2::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
